...
def open_view_nii(nii_filename, x, y, z):
    ...
    ax1.matshow(nii_data[x, :, :], cmap=plt.cm.gray)

    #coronal plane view
    ax2         = plt.subplot(2, 2, 2)
    ax2.matshow(nii_data[:,y,:], cmap=plt.cm.gray)

    #axial plane view
    ax3         = plt.subplot(2, 2, 3)
    ax3.matshow(nii_data[:, :, z], cmap=plt.cm.gray)
...
if __name__ == '__main__':
    ...
    open_view_nii('../data_lesson3/example1.nii',  100,150,150)
